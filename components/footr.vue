<template>
  <div class="bg-gray-800 text-white">
    <footer class="py-8 px-4 lg:px-0 xl:px-0 container mx-auto">
      <div class="grid grid-cols-1 lg:grid-cols-6 xl:grid-cols-6 gap-4">
        <div>
          <ul class="space-y-2">
            <li>
              <a href="#">About Blowhorn</a>
            </li>
            <li>
              <a href="#">Solutions</a>
            </li>
            <li>
              <a href="#">People & Values</a>
            </li>
            <li>
              <a href="#">Careers</a>
            </li>
        ...
        <div>
          <ul class="space-y-2">
            <li>
              <a href="tel:+918045683500">+91 8045683500</a>
            </li>
            <li>
              <a href="tel:+914448134000">+91 4448134000</a>
            </li>
            <li>
              <a href="tel:+911140849988">+91 1140849988</a>
            </li>
            <li>
              <a href="tel:+914045208000">+91 4045208000</a>
            </li>
            <li>
              <a href="tel:+912248931300">+91 2248931300</a>
            </li>
          </ul>
        </div>
        <div class="col-span-1 lg:col-span-2 xl:col-span-2">
          <div class="pb-2 border-b-2 border-white mb-2">
            <p>Contact Us</p>
          </div>
          <div class="flex items-center justify-between">
            <div>
              <p class="text-sm">Email Us</p>
              <a href="mailto:shoutout@blowhorn.com">shoutout@blowhorn.com </a>
            </div>
            <div>
              <p class="text-sm">Reach us on social Media</p>
        ...
        <div class="space-y-2">
          <div class="pb-2 border-b-2 border-white">
            <p>Download apps</p>
          </div>
          <img
            src="https://blowhorn.com/static/website/images/applestore-badge.png"
            class="mx-auto h-8 w-auto"
            alt="App store"
          />
          <img
            src="https://blowhorn.com/static/website/images/google-play-badge.png"
            class="mx-auto h-8 w-auto"
            alt="App store"
          />
        </div>
